...
[file=folder=link|private]
	<tr class='{.if|{.mod|{.count|row.}|2.}|even.}'><td>
		...
		{.if not|{.%item-ext%|~img_folder.}|<a href="%item-url%" > <img src="%item-icon%"> %item-name%</a>|<a href="#" onclick="player('%item-url%','%item-name%','video');" disabled> <img src="%item-icon%"> %item-name%</a>
		.}
...
[+file]
<td>%item-size%B<td>%item-modified%<td>%item-dl-count%<td>
